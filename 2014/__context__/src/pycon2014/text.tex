...
Chcielibyśmy przy okazji zwrócić szczególną uwagę na powstające stowarzyszenie Polska Grupa Użytkowników Pythona (PLPUG). Warto zaangażować się w działania grupy, która ma na celu wsparcie społeczności programistów Pythona w Polsce i już niedługo zakończy się formalizować.  Zapraszamy więc gorąco na piątek wieczór do szerokiej dyskusji w tym temacie.
...
Pragniemy zwrócić szczególną uwagę, że ta książka, którą trzymasz w rękach, powstała wspólnym wysiłkiem za pośrednictwem publicznego repozytorium  na Githubie, gdzie każdy może wnieść swój wkład w treść i formę zamieszczonych tam materiałów. Jeśli podoba Ci się ta idea, to zapraszamy do współpracy w przyszłym roku:
