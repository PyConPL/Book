...
\centerline{\externalfigure[src/webinterpret-logo.pdf][width=0.6\hsize,frame=on]}

\ListaPlac Złoci Sponsorzy:~\par%\blank[2*big]
\centerline{\externalfigure[src/Vector_B+W_MirantisLogo.pdf][width=0.45\hsize,frame=on]\hskip10mm\externalfigure[src/intel_blk_100.pdf][width=0.45\hsize,frame=on]}
\centerline{\externalfigure[src/logo-applause-gray.png][width=0.45\hsize,frame=on]\hskip10mm\externalfigure[src/daftcode_logo.pdf][width=0.45\hsize,frame=on]}
\centerline{\externalfigure[src/logo_wp_bw.png][width=0.45\hsize,frame=on]\hskip10mm\externalfigure[src/mslogo_b.png][width=0.45\hsize,frame=on]}

\ListaPlac Srebrni Sponsorzy:\par
\centerline{\externalfigure[src/compendium.png][width=0.4\hsize,frame=on]\hskip10mm\externalfigure[src/Samsung_bw.pdf][width=0.4\hsize,frame=on]}

\centerline{\externalfigure[src/transporeon_bw.pdf][width=0.4\hsize,frame=on]\hskip10mm\externalfigure[src/stx-logo_gray.png][width=0.4\hsize,frame=on]}
\centerline{\externalfigure[src/Codility_logo_bw.pdf][width=0.4\hsize,frame=on]\hskip10mm\externalfigure[src/Red_Hat_BW_rgb.pdf][width=0.4\hsize,frame=on]}
\centerline{\externalfigure[src/smt_CMYK.pdf][width=0.2\hsize,frame=on]\hskip10mm\externalfigure[src/BaseLab-Black-RGB.pdf][width=0.4\hsize,frame=on]}

\ListaPlac Brązowi Sponsorzy:\par
\centerline{\externalfigure[src/hurra_Logo_SW.pdf][width=0.25\hsize,frame=on]\hskip20mm\externalfigure[src/ORM_logo_cmyk.pdf][width=0.4\hsize,frame=on]}
\centerline{\externalfigure[src/hb-full.pdf][width=0.4\hsize,frame=on]\hskip10mm\externalfigure[src/egnyte-lightbg-vector.pdf][width=0.4\hsize,frame=on]}

\ListaPlac Grafitowi Sponsorzy:\par
\centerline{\externalfigure[src/helion.png][width=0.6\hsize,frame=on]\hskip10mm\externalfigure[src/logo-raspi.pdf][width=0.2\hsize,frame=on]}
\centerline{\externalfigure[src/packt-logo-med-res-transparent.png][width=0.4\hsize,frame=on]\hskip10mm\externalfigure[src/two-scoops-press.png][width=0.4\hsize,frame=on]}
\centerline{\externalfigure[src/FINAL_LOGO_TECHLAND-black-ver8.pdf][width=0.4\hsize,frame=on]\hskip10mm\externalfigure[src/logo_kinetise.png][width=0.4\hsize,frame=on]}
\break
...
Warto też wspomnieć, że ta książka, którą trzymasz w rękach, powstała wspólnym wysiłkiem za pośrednictwem publicznego repozytorium  na Githubie, gdzie każdy może wnieść swój wkład w treść i formę zamieszczonych tam materiałów. Jeśli podoba Ci się ta idea, to zapraszamy do współpracy w przyszłym roku:
