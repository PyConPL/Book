...
\item
  {[}asyncio{]}
  \hyphenatedurl{https://docs.python.org/3/library/asyncio.html}
\item
  {[}BER{]}
  \hyphenatedurl{https://en.wikipedia.org/wiki/X.690\#BER_encoding}
\item
  {[}command-line tools{]}
  \hyphenatedurl{https://pypi.python.org/pypi/pysnmp-apps}
\item
...
\item
  {[}PyCrypto{]}
  \hyphenatedurl{https://www.dlitz.net/software/pycrypto/}
\item
...
\item
  {[}SimConfig{]}
  \hyphenatedurl{http://snmpsim.sourceforge.net/public-snmp-simulator.html}
\item
  {[}SNMP Agent emulation software{]}
  \hyphenatedurl{https://en.wikipedia.org/wiki/SNMP_simulator}
\item
