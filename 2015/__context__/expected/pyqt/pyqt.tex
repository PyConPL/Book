...
\item
  {[}1{]} Strona PyQt
  \hyphenatedurl{https://www.riverbankcomputing.com/software/pyqt/intro}
\item
  {[}2{]} Class Reference PyQt5
  \hyphenatedurl{http://pyqt.sourceforge.net/Docs/PyQt5/class_reference.html}
\item
  {[}3{]} Rapid GUI Programming with Python and Qt
  \hyphenatedurl{http://www.qtrac.eu/pyqtbook.html}
\item
  {[}4{]} GUI Programming with Python: QT Edition
  \hyphenatedurl{https://www.commandprompt.com/community/pyqt/}
\item
  {[}5{]} Poradniki PyQt4
  \hyphenatedurl{http://www.python.rk.edu.pl/w/p/pyqt/}
\stopitemize
