...
\item
  https://pl.wikipedia.org/wiki/Wyrażenie\letterunderscore{}regularne
\item
  Speech and Language Processing: An introduction to natural language
  processing, computational linguistics, and speech recognition. Daniel
  Jurafsky \& James H. Martin
\item
  \hyphenatedurl{https://pl.wikipedia.org/wiki/Maszyna_Turinga}
\item
  \hyphenatedurl{https://pl.wikipedia.org/wiki/Neuron_McCullocha-Pittsa}
\item
  http://blog.staffannoteberg.com/2013/01/30/\crlf
  regular-expressions-a-brief-history/
\item
  \hyphenatedurl{http://books.google.com/books?id=oL57iECEeEwC}
\item
  \hyphenatedurl{https://pl.wikipedia.org/wiki/Język_regularny}
\item
  \hyphenatedurl{http://kelty.org/or/papers/Kelty_Franchi_LogicalInstruments_2009.pdf}
\item
  https://www.cs.ucf.edu/\lettertilde{}dcm/Teaching/COP5611Spring2010/\crlf
  vonNeumannSelfReproducingAutomata.pdf
\item
  \hyphenatedurl{https://en.wikipedia.org/wiki/Janusz_Brzozowski_(computer_scientist)}
\item
  \hyphenatedurl{https://en.wikipedia.org/wiki/Rudolf_Carnap\#Logical_syntax}
\item
  \hyphenatedurl{https://pl.wikipedia.org/wiki/Ken_Thompson}
\item
  \hyphenatedurl{https://pl.wikipedia.org/wiki/Unix}
\item
  \hyphenatedurl{http://www.fing.edu.uy/inco/cursos/intropln/material/p419-thompson.pdf}
\stopitemize
