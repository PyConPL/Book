...
\placefigure[here,nonumber]{Alt
text}{\externalfigure[./001_web_sockets.png]}
...
\useURL[url4][https://www.thalmic.com/myo/][][Myo Armband]\from[url4]
\useURL[url5][https://www.leapmotion.com][][Leap Motion]\from[url5]
\useURL[url6][https://theeyetribe.com][][EyeTribe]\from[url6]
\useURL[url7][https://flask-socketio.readthedocs.org/en/latest/][][flask-SocketIO
documentation]\from[url7]
\useURL[url8][http://flask.pocoo.org/docs/0.10/][][Flask
docs]\from[url8] \useURL[url9][http://socket.io][][Socket.IO]\from[url9]
