...
\item
  {[}1{]} Astronomia -
  \hyphenatedurl{https://pl.wikipedia.org/wiki/Astronomia}
\item
  {[}2{]} Układy współrzędnych w astronomii -
  \hyphenatedurl{http://www.astro.amu.edu.pl/~jopek/JopekTJ/Dydaktyka/A_Sf/2014-15/Prezentacje/wyklad_03.pdf}
\item
...
\item
  {[}5{]} Bifurikacja -
  \hyphenatedurl{http://zasoby1.open.agh.edu.pl/dydaktyka/matematyka/c_fraktale_i_chaos/chaos.php?rozdzial=2}
\item
