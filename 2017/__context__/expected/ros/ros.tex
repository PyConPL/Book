...
\section[rapidly-prototyping-robotics-with-ros-and-ipython]{Rapidly
Prototyping Robotics with ROS and IPython}
...
\startitemize
\item
  \useURL[url1][https://www.youtube.com/watch?v=sF0tRCqvyT0][][play and
  teach children]\from[url1]
\item
  explore
  \useURL[url2][https://www.youtube.com/watch?v=EgtZAUDqxHE][][underwater]\from[url2]
  or \useURL[url3][https://vimeo.com/146183080][][space]\from[url3]
\item
  be a
  \useURL[url4][https://www.youtube.com/watch?v=dx0zxr3D_zU][][companion]\from[url4]
  or a
  \useURL[url5][https://www.youtube.com/watch?v=p92415PxgCw][][teleoperation]\from[url5]
  tool
\item
  and so much more. Did you see a robot that can
  \useURL[url6][https://www.youtube.com/watch?v=_luhn7TLfWU][][jump and
  paraglide]\from[url6]? Or the
  \useURL[url7][https://www.youtube.com/watch?v=rVlhMGQgDkY][][creepy
  one]\from[url7] that can walk on its own and open doors?
  \useURL[url8][http://mir1.hitchbot.me/][][Or the one that hitchhiked
  through Canada]\from[url8]?
\stopitemize
...
social or just
\useURL[url9][https://www.youtube.com/watch?v=3g-yrjh58ms][][be
cute]\from[url9].
...
\useURL[url10][http://wiki.ros.org/ROS/Tutorials][][ROS
tutorials]\from[url10] are a very good start.

There is a
\useURL[url11][http://wiki.ros.org/Books/ROSbyExampleVol2][][Patrick
Goebel book]\from[url11] which shows how you can use and combine these
tools (and couple more) to create a mobile robot with arms that can make
map of its own environment to plan his movement and not bump into things
...
--
\useURL[url12][https://www.udacity.com/course/artificial-intelligence-for-robotics--cs373][][AI
for robotics]\from[url12] on Udacity is a way that Igor started using
Python seriously.
