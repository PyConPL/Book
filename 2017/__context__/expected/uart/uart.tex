...
definiuje długość danych, obecność bitu parzystości oraz liczbę bitów
...
transmisji danych od 110 do 115200 bitów na sekundę. Maksymalna długość
przewodu łączącego urządzenia wynosi nawet 100 m i spada wraz ze
wzrostem prędkości transmisji {[}1, 2{]}.
...
liczby urządzeń slave. Urządzenia slave identyfikowane są za pomocą
...
bitów na sekundę. Protokół zakłada niezbyt częste odczytywanie
mierzonych wartości {[}7{]}.
...
trzy typy urządzeń ZigBee:

\startitemize[packed]
\item
  koordynator (ZC) - jest to węzeł początkowy sieci, do którego
  przyłączają się inne urządzenia, w sieci może występować tylko jedno
  takie urządzenie,
\item
