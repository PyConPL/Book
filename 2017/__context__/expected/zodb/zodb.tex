...
ZODB is really easy to use from Python {[}4{]}. Just subclass off of
class persistent. Persistent, and your objects become persistent. Here
is a code sample from the Tutorial.
...
be displayed or edited. These is no need to know Unix. But you do have
