...
\item
  BeeBox
  project{]}(https://sourceforge.net/projects/bwapp/files/bee-box/)
\item
  OWASP Broken Web Applications Project (OWASP
  BWAP){]}(https://www.owasp.org/index.php/OWASP\type{_}Broken\type{_}Web\type{_}Applications\type{_}Project)
\item
