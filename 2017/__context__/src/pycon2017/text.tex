...
Nasze wydarzenie już po raz trzeci gości w Hotelu Ossa. Tym razem spotykamy się
trochę nietypowo, bo latem. Sierpniowy termin naszej konferencji ułatwia nam
sprawy organizacyjne i pozwala lepiej przygotować się do wydarzenia. Liczymy
też na to, że letnia aura pozwoli nam po wielu latach przerwy zorganizować
grilla na świeżym powietrzu (z uwagą śledzimy aktualne prognozy pogody).

W tym roku, poza kolejnymi warsztatami PyLadies, odbędą się również warsztaty Data Carpentry
oraz ścieżki PyData. Chcemy, by w przyszłości PyCon PL rozwijał się w kierunku
wielu specjalizowanych podwydarzeń, gdyż liczba nowych zastosowań Pythona i popularność
języka ciągle rośnie.

Po wielu nieudanych inicjatywach zbudowania ogólnopolskiego stowarzyszenia dla
wsparcia popularyzacji  języka Python ruszamy ze stowarzyszeniem PyPolska. Bogatsi o doświadczenia
i wiele przykładów, jak nie należy zabierać się za budowanie stowarzyszenia, zdecydowaliśmy
się na trochę inne podejście, by zbudować sprawnie działającą organizację. Liczymy na to, że
wniesie ona nową jakość do społeczności Pythona w Polsce już niedługo. Czy tak będzie, przekonamy się pewnie
w okresie do następnego PyCona PL.
