...
\vskip12mm
\centerline{\externalfigure[src/codilime.png][width=0.45\hsize]\externalfigure[src/stx.png][width=0.45\hsize]}
\centerline{\externalfigure[src/compendium.png][width=0.45\hsize]}

\ListaPlac Brązowi Sponsorzy:\par
\vskip12mm
\centerline{\externalfigure[src/xcaliber.png][width=0.45\hsize]\externalfigure[src/RockwellAutomation.png][width=0.45\hsize]}
\centerline{\externalfigure[src/CodersLab.png][width=0.45\hsize]\externalfigure[src/gp.png][width=0.15\hsize]}

\ListaPlac Grafitowi Sponsorzy:\par
\vskip12mm
\centerline{\externalfigure[src/Helion.png][width=0.45\hsize]\externalfigure[src/itpwn.png][width=0.45\hsize]}
\centerline{\externalfigure[src/logo_JetBrains_1.png][width=0.45\hsize]}

\ListaPlac Partner techniczny:\par
\centerline{\externalfigure[src/litex.png][width=0.45\hsize]}
\vskip12mm
\break
